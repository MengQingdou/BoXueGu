...
import com.example.boxuegu.adapter.AdBannerAdapter;
...
public class CourseView {
    ...
    private List<List<CourseBean>> cbl; // 这个是为了放课程的
        ...
        adPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (ada.getSize() > 0) {
                    ...
                    vpi.setCurrentPosition(i % ada.getSize());
                }
            }
            @Override
     ...
     * 读取屏幕宽
     */
    public static int getScreenWidth(Activity contexr){
        DisplayMetrics metrics = new DisplayMetrics();
        Display display = contexr.getWindowManager().getDefaultDisplay();
