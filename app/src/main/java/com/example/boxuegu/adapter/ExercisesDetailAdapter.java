...
import com.example.boxuegu.bean.ExercisesBean;
...
public class ExercisesDetailAdapter extends BaseAdapter {
    private static final String TAG = "ExercisesDetailAdapter";
