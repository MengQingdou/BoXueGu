...
import com.example.boxuegu.sqlite.SQLiteHelper;
...
public class DBUtils {
    ...
    public void updateUserInfo(String key, String value, String userName){
        ...
        Log.d(TAG, "updateUserInfo: 这个函数确实运行了");
    }
    ...
    public void saveVideoPlayList(VideoBean bean, String userName){
        ...
        Log.d(TAG, "将用户" + userName + "的播放记录进行保存");
    }
    /**
     * 判断视频记录是否存在
     */
    public boolean hasVideoPlay(int chapterId, int videoId, String userName){
        ...
        cursor.close();
        Log.d(TAG, "之前视频记录是否存在过" + hasVideo);
        return hasVideo;
    }
    /**
     * 删除已经存在的视频记录
