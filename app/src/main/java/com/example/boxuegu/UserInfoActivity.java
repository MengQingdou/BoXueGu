...
public class UserInfoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView tv_userName,tv_nickName, tv_sex, tv_signature;
    private RelativeLayout rl_nickName, rl_sex, rl_signature, rl_title_bar;
    private String spUserName;
    private static final int CHANGE_NICKNAME = 1;   // 修改昵称的自定义变量
    private static final int CHANGE_SIGNATURE = 2;  // 修改签名的自定义变量
    ...
    /**
     * 获取回传数据时需使用的跳转方法，第一个参数to表示需要跳转的界面，第2个参数requestCode表示一个请求码，第3个参数b表示跳转时传递的数据
     */
    ...
    /**
     * 用于接收回传过来的数据，当接收到新数据后将用户输入的新的个人信息保存到数据库中
     */
        ...
        switch (requestCode){
            ...
            case CHANGE_NICKNAME:
                if(data!=null){
                    ...
                    Log.d(TAG, "onActivityResult: 这时候用户信息界面接收到了从修改界面传递回来的新昵称" + new_info);
